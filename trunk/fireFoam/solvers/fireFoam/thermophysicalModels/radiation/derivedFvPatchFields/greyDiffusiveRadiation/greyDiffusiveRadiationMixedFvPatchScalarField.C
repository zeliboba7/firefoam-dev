...
NamedEnum
<
    greyDiffusiveRadiationMixedFvPatchScalarField::emissivityMode,
    2
>::names[] =
{
    "lookup",
...
<
    ...
    2
>
greyDiffusiveRadiationMixedFvPatchScalarField::emissivityModeNames_;
        ...
        if ((-n[faceI] & d) > 0.0)
        {
            ...
            refValue()[faceI] =
                (
                  ...
                  + emissivity_[faceI]
                  * radiation::sigmaSB.value()*pow4(Tp[faceI])
                )
