...
Foam::combustionModels::eddyDissipationModel::R(volScalarField& Y) const
{
...
Foam::combustionModels::eddyDissipationModel::dQ() const
{
    const label fuelI = singleMixture_.fuelIndex();
...
Foam::tmp<Foam::volScalarField>
Foam::combustionModels::eddyDissipationModel::wFuelNorm() const
{
    return wFuelNorm_;
}
