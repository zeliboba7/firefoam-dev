...
#include "turbulentTemperatureRadiationCoupledMixedFvPatchScalarField.H"
...
turbulentTemperatureRadiationCoupledMixedFvPatchScalarField
(
    const turbulentTemperatureRadiationCoupledMixedFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
tmp<scalarField>
turbulentTemperatureRadiationCoupledMixedFvPatchScalarField::K() const
{
...
void turbulentTemperatureRadiationCoupledMixedFvPatchScalarField::
updateCoeffs()
{
    if (updated())
    {
...
void turbulentTemperatureRadiationCoupledMixedFvPatchScalarField::write
(
    Ostream& os
) const
{
