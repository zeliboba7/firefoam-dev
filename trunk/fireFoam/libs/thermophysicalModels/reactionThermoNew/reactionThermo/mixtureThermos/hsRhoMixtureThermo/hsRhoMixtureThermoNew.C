...
void Foam::hsRhoMixtureThermoNew<MixtureType>::calculate()
{
...
template<class MixtureType>
Foam::hsRhoMixtureThermoNew<MixtureType>::hsRhoMixtureThermoNew(const fvMesh& mesh)
:
...
template<class MixtureType>
Foam::hsRhoMixtureThermoNew<MixtureType>::~hsRhoMixtureThermoNew()
{}
...
template<class MixtureType>
void Foam::hsRhoMixtureThermoNew<MixtureType>::correct()
{
    if (debug)
    {
        Info<< "entering hsRhoMixtureThermoNew<MixtureType>::correct()" << endl;
    }
    ...
    if (debug)
    {
        Info<< "exiting hsRhoMixtureThermoNew<MixtureType>::correct()" << endl;
    }
}
...
Foam::hsRhoMixtureThermoNew<MixtureType>::hc() const
{
...
Foam::hsRhoMixtureThermoNew<MixtureType>::hs
(
    const scalarField& T,
...
template<class MixtureType>
Foam::tmp<Foam::scalarField>
Foam::hsRhoMixtureThermoNew<MixtureType>::Cp
(
    const scalarField& T,
    const label patchi
) const
...
template<class MixtureType>
Foam::tmp<Foam::volScalarField>
Foam::hsRhoMixtureThermoNew<MixtureType>::Cp() const
{
    const fvMesh& mesh = T_.mesh();
...
template<class MixtureType>
bool Foam::hsRhoMixtureThermoNew<MixtureType>::read()
{
