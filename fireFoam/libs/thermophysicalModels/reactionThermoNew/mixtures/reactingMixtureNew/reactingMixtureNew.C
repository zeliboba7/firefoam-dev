...
Foam::reactingMixtureNew<ThermoType>::reactingMixtureNew
(
...
:
    ...
    multiComponentMixtureNew<ThermoType>
    (
        thermoDict,
...
template<class ThermoType>
void Foam::reactingMixtureNew<ThermoType>::read(const dictionary& thermoDict)
{}
