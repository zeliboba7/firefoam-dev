...
void Foam::singleStepReactingMixture<ThermoType>::calculateqFuel()
{
    ...
    Info << "Mole based specieStoichCoeffs: " << specieStoichCoeffs_ << endl;
}
...
void Foam::singleStepReactingMixture<ThermoType>::calculateMaxProducts()
{
    ...
    Info << "mass based specieStoichCoeffs: " << specieStoichCoeffs_ << endl;
}
...
:
    reactingMixtureNew<ThermoType>(thermoDict, mesh),
