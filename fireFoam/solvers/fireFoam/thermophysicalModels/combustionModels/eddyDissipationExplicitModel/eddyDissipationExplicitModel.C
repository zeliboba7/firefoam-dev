...
#include "eddyDissipationExplicitModel.H"
...
{
    defineTypeNameAndDebug(eddyDissipationExplicitModel, 0);
    addToRunTimeSelectionTable
    (
        combustionModel,
        eddyDissipationExplicitModel,
        dictionary
    );
};
};
...
Foam::combustionModels::eddyDissipationExplicitModel::eddyDissipationExplicitModel
(
...
void Foam::combustionModels::eddyDissipationExplicitModel::correct()
{
    ...
    if (thermo_.composition().contains("O2"))
    {
        ...
        wFuelNorm_ = C_*rho_*turbulence_.epsilon()
                            /max(turbulence_.k(),dimensionedScalar("SMALL",dimVelocity*dimVelocity,SMALL))
...
Foam::combustionModels::eddyDissipationExplicitModel::R(volScalarField& Y) const
{
...
Foam::combustionModels::eddyDissipationExplicitModel::dQ() const
{
    const label fuelI = singleMixture_.fuelIndex();
...
Foam::tmp<Foam::volScalarField>
Foam::combustionModels::eddyDissipationExplicitModel::wFuelNorm() const
{
    return wFuelNorm_;
}


bool Foam::combustionModels::eddyDissipationExplicitModel::read
(
    const dictionary& combustionProps
)
{
